...
const Filters = ({nav}) => {
    ...
    const handelFilter = (index) => {
        if(selected.includes(index)){
            const newSelected = selected.filter(v=> v !== index);
